...
def compile_binaries(isDebug):        
    cmake_cmd = 'cmake -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DTERRIER_USE_ASAN=OFF -DTERRIER_USE_JEMALLOC=ON -DTERRIER_BUILD_TESTS=OFF .. '
    make_cmd = 'make -j4 terrier'
    compile_commands = [cmake_cmd,make_cmd]
