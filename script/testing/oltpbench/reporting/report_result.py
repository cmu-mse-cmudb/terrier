...
def report(api_url, results_dir, query_mode='simple'):
    ...
    send_results(api_url,results)


def send_results(api_url,results):
    result = requests.post(api_url + '/oltpbench/', json=results)
